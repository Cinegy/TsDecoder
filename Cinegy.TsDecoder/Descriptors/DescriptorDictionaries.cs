...
namespace Cinegy.TsDecoder.Descriptors
{
    ...
    {
        //See ISO/IEC 1318-1:2019 Table 2-34
        ...
        //See ISO/IEC 1318-1:2019 Table 2-45
        public static readonly Dictionary<int, string> DescriptorTypeDescriptions = new Dictionary<int, string>()
        {
            ...
            {55,"Reserved"},
            {56,"Video stream header parameters for ITU-T Rec. H.265 and ISO/IEC 23008-2"},
            {57,"Reserved"},
            {58,"Reserved"},
            {59,"Reserved"},
            {60,"Reserved"},
        ...
        public static readonly Dictionary<int, string> DescriptorTypeShortDescriptions = new Dictionary<int, string>()
        {
            ...
            {55,"Reserved"},
            {56,"Video stream header params H.265"},
            {57,"Reserved"},
            {58,"Reserved"},
            {59,"Reserved"},
            {60,"Reserved"},
